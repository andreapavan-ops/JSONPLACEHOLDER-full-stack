...
INSERT INTO utenti (id, nome, email, citta, sesso, codiceFiscale, dataNascita, telefono) VALUES
    (1, 'Mario Rossi',   'mario@email.com',  'Roma',    'M',     'RSSMRA80A01H501A', '1980-01-01', '+39 333 1234567'),
    (2, 'Luigi Verdi',   'luigi@email.com',  'Milano',  'M',     'VRDLGU75B12F205Z', '1975-02-12', NULL),
    (3, 'Peach Bianchi', 'peach@email.com',  'Napoli',  'F',     'BNCPCH90C43F839X', '1990-03-25', '+39 347 9876543'),
    (4, 'Toad Gialli',   'toad@email.com',   'Torino',  'Altro', 'GLLTDO85D44L219W', NULL,         NULL),
    (5, 'Bowser Neri',   'bowser@email.com', 'Firenze', 'M',     'NREBWS70E01D612V', '1970-05-01', '+39 320 5554433');
